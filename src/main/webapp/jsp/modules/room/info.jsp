            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">房间登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="building" name="building" class="form-control"
                                               v-model="ruleForm.building" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="unit" name="unit" class="form-control"
                                               v-model="ruleForm.unit" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="roomNumber" name="roomNumber" class="form-control"
                                               v-model="ruleForm.roomNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fangchanNumber" name="fangchanNumber" class="form-control"
                                               v-model="ruleForm.fangchanNumber" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.roomContent != null && ruleForm.roomContent != 'null' && ruleForm.roomContent != '') {
            var roomContentUeditor = UE.getEditor('roomContentEditor');
                roomContentUeditor.ready(function () {
                    var mes = '' + ruleForm.roomContent;
                    roomContentUeditor.setContent(mes);
                    roomContentUeditor.setDisabled('fullscreen');
            });
        }
    }
