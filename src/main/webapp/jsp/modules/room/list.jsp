...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="buildingSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="楼幢" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        房间号
                                        <div class="layui-input-inline">
                                            <input type="text" id="roomNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        房产编号
                                        <div class="layui-input-inline">
                                            <input type="text" id="fangchanNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="房产编号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //房间号
            var roomNumberSearchInput = $('#roomNumberSearch');
            if( roomNumberSearchInput != null){
                if (roomNumberSearchInput.val() != null && roomNumberSearchInput.val() != '') {
                    searchForm.roomNumber = $('#roomNumberSearch').val();
                }
            }
     
            //房产编号
            var fangchanNumberSearchInput = $('#fangchanNumberSearch');
            if( fangchanNumberSearchInput != null){
                if (fangchanNumberSearchInput.val() != null && fangchanNumberSearchInput.val() != '') {
                    searchForm.fangchanNumber = $('#fangchanNumberSearch').val();
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("room/page", "GET", {
                ...
                fangchanNumber: searchForm.fangchanNumber,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            roomNumberCell.innerHTML = item.roomNumber;
            row.appendChild(roomNumberCell);


            //房产编号
            var fangchanNumberCell = document.createElement('td');
            fangchanNumberCell.innerHTML = item.fangchanNumber;
            row.appendChild(fangchanNumberCell);


                //房间信息
            var roomContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.roomContent && item.roomContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.roomContent.indexOf('<img');
                var endIndex = item.roomContent.indexOf('>');
                    roomContentCell.innerHTML = item.roomContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.roomContent != null && item.roomContent != "" && item.roomContent.length >= 11) {
                        roomContentCell.innerHTML = item.roomContent.substring(0, 10) + "...";
                } else {
                        roomContentCell.innerHTML = item.roomContent;
                }
            }
            row.appendChild(roomContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("room/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addroom", "addroom");
            window.location.href = "add-or-update.jsp"
        }
