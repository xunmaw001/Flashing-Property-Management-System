...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">售水管理</li>
                            <li class="breadcrumb-item active">售水列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            // 整数
            function shuibiaoNumberChickValue(e){
