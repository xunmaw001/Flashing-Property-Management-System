            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">车位登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="cheweiNumber" name="cheweiNumber" class="form-control"
                                               v-model="ruleForm.cheweiNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="cheweiAddress" name="cheweiAddress" class="form-control"
                                               v-model="ruleForm.cheweiAddress" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>租用开始日期</label>
                                        <input id="cheweiShiyongStartTime" name="cheweiShiyongStartTime" class="form-control"
                                               v-model="ruleForm.cheweiShiyongStartTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>租用结束日期</label>
                                        <input id="cheweiShiyongEndTime" name="cheweiShiyongEndTime" class="form-control"
                                               v-model="ruleForm.cheweiShiyongEndTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="cheweiZujin" name="cheweiZujin" class="form-control"
                                               v-model="ruleForm.cheweiZujin" readonly>
                                    </div>
