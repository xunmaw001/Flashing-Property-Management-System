                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>停车编号</label>
                                        <input id="cheweiNumber" name="cheweiNumber" class="form-control"
                                               placeholder="停车编号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>车位位置</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>租用开始日期</label>
                                        <input id="cheweiShiyongStartTime-input" name="cheweiShiyongStartTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>租用结束日期</label>
                                        <input id="cheweiShiyongEndTime-input" name="cheweiShiyongEndTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>租金</label>
                                        <input id="cheweiZujin" name="cheweiZujin" class="form-control"
                                               onchange="cheweiZujinChickValue(this)"  placeholder="租金">
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                cheweiNumber: "required",
                cheweiAddress: "required",
                cheweiShiyongStartTime: "required",
                cheweiShiyongEndTime: "required",
                cheweiZujin: "required",
                insertTime: "required",
            },
            messages: {
                yonghuId: "用户不能为空",
                cheweiNumber: "停车编号不能为空",
                cheweiAddress: "车位位置不能为空",
                cheweiShiyongStartTime: "租用开始日期不能为空",
                cheweiShiyongEndTime: "租用结束日期不能为空",
                cheweiZujin: "租金不能为空",
                insertTime: "添加时间不能为空",
            }
        }).form();
    ...
    function dateTimePick() {
            laydate.render({
                elem: '#cheweiShiyongStartTime-input'
                ,type: 'datetime'
            });
            laydate.render({
                elem: '#cheweiShiyongEndTime-input'
                ,type: 'datetime'
            });
            laydate.render({
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#cheweiNumber").val(ruleForm.cheweiNumber);
        $("#cheweiAddress").val(ruleForm.cheweiAddress);
        $("#cheweiShiyongStartTime-input").val(ruleForm.cheweiShiyongStartTime);
        $("#cheweiShiyongEndTime-input").val(ruleForm.cheweiShiyongEndTime);
        $("#cheweiZujin").val(ruleForm.cheweiZujin);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
        if(window.sessionStorage.getItem('addchewei') != null && window.sessionStorage.getItem('addchewei') !=""){//新增查询,修改不查
            // 查询当前登录账户的信息
            var userId = window.sessionStorage.getItem('userId');
