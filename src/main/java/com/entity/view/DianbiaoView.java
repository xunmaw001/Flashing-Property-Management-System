 ...
 */
@TableName("dianbiao")
public class DianbiaoView extends DianbiaoEntity implements Serializable {
	...
	public DianbiaoView(DianbiaoEntity dianbiaoEntity) {
		try {
			BeanUtils.copyProperties(this, dianbiaoEntity);
